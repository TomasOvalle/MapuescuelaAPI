...
@Component("finalizarPedidoDelegate")
public class FinalizarPedidoDelegate implements JavaDelegate {
    private final PreparacionPedidoService preparacionPedidoService;

    public FinalizarPedidoDelegate(
    ...
    public void execute(DelegateExecution execution) {
        ...
        preparacionPedidoService.finalizarPedido(pedidoId);
    }
}
